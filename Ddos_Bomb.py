...
def help():
    print("""
Dos/DDos Timebomb 
Created by: Rexxagore
WhatsApp:089525307729
...
python3 Ddos_Bomb.py -t (target website) -p (portwebsite) -m (jam serangan dimulai) -s (jam serangan selesai) --message (pesan)
